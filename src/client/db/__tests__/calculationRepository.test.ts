  ...
  it("应该保存计算记录", async () => {
    ...
    const results = {
      up: {
        ...
        dailyDetails: [{ day: 1, openPrice: 10, closePrice: 11, dailyGain: 1, dailyReturnPercent: 10 }],
      ...
      down: {
        ...
        dailyDetails: [{ day: 1, openPrice: 10, closePrice: 9, dailyGain: -1, dailyReturnPercent: -10 }],
        keyMetrics: { doubleDays: null, tenXDays: null, breakEvenReturn: 0, annualizedReturn: -1000 },
      },
    };
